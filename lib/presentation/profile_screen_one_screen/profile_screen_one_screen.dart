...
import '../profile_screen_one_screen/widgets/dentist_item_widget.dart';
import '../profile_screen_one_screen/widgets/dentist2_item_widget.dart';
import '../profile_screen_one_screen/widgets/dentist4_item_widget.dart';
import '../profile_screen_one_screen/widgets/dentist6_item_widget.dart';
import 'package:doctari/widgets/custom_elevated_button.dart';
import 'package:flutter/material.dart';
import 'package:doctari/core/app_export.dart';

// ignore_for_file: must_be_immutable
class ProfileScreenOneScreen extends StatelessWidget {
  ProfileScreenOneScreen({Key? key}) : super(key: key);
                                      ...
                                      children: [
                                        ...
                                        Text("Medical Data",
                                            style: CustomTextStyles
                                                .titleMediumBluegray90005),
                                        SizedBox(height: 8.v),
                                        _buildWeightKg(context),
                                        SizedBox(height: 11.v),
                                        _buildHeightCm(context),
                                        SizedBox(height: 11.v),
                                        _buildSelectMedicine(context),
                                        SizedBox(height: 11.v),
                                        _buildDentist(context),
                                        SizedBox(height: 11.v),
                                        _buildSelectAllergie(context),
                                        SizedBox(height: 11.v),
                                        _buildDentist1(context),
                                        SizedBox(height: 11.v),
                                        _buildSelectDisease(context),
                                        SizedBox(height: 11.v),
                                        _buildDentist2(context),
                                        SizedBox(height: 11.v),
                                        _buildNameSurgeries(context),
                                        SizedBox(height: 11.v),
                                        _buildDentist3(context)
                                      ]))))
                    ]))),
  ...
  /// Section Widget
  Widget _buildWeightKg(BuildContext context) {
    return CustomFloatingTextField(
  ...
  /// Section Widget
  Widget _buildHeightCm(BuildContext context) {
    return CustomFloatingTextField(
  ...
  /// Section Widget
  Widget _buildSelectMedicine(BuildContext context) {
    return CustomFloatingTextField(
  ...
  Widget _buildDentist(BuildContext context) {
    return Wrap(
        runSpacing: 10.v,
        spacing: 10.h,
        children: List<Widget>.generate(3, (index) => DentistItemWidget()));
  }

  /// Section Widget
  Widget _buildSelectAllergie(BuildContext context) {
    return CustomFloatingTextField(
        controller: selectAllergieController,
        labelText: "Allergies",
        labelStyle: CustomTextStyles.bodyLargeRubik,
        hintText: "Allergies",
        hintStyle: CustomTextStyles.bodyLargeRubik,
  ...
  Widget _buildDentist1(BuildContext context) {
    return Wrap(
        runSpacing: 10.v,
        spacing: 10.h,
        children: List<Widget>.generate(3, (index) => Dentist2ItemWidget()));
  }

  /// Section Widget
  Widget _buildSelectDisease(BuildContext context) {
    return CustomFloatingTextField(
        controller: selectDiseaseController,
        labelText: "Diseases",
        labelStyle: theme.textTheme.bodyLarge!,
        hintText: "Diseases",
        suffix: Container(
  ...
  /// Section Widget
  Widget _buildDentist2(BuildContext context) {
    return Wrap(
        runSpacing: 10.v,
        spacing: 10.h,
        children: List<Widget>.generate(3, (index) => Dentist4ItemWidget()));
  }

  /// Section Widget
  Widget _buildNameSurgeries(BuildContext context) {
    return CustomFloatingTextField(
        controller: nameSurgeriesController,
  ...
  /// Section Widget
  Widget _buildDentist3(BuildContext context) {
    return Wrap(
        runSpacing: 10.v,
        spacing: 10.h,
        children: List<Widget>.generate(2, (index) => Dentist6ItemWidget()));
  }
  ...
  Widget _buildContinue(BuildContext context) {
    return CustomElevatedButton(
        text: "Continue",
        margin: EdgeInsets.only(left: 40.h, right: 40.h, bottom: 18.v),
