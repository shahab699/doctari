...
class RescheduleSuccessfulDialog extends StatelessWidget {
  const RescheduleSuccessfulDialog({Key? key})
      : super(
          key: key,
        );
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Your appointment with Abdul Rehman is confirmed for September 30, 2024, at 03:00 PM.",
              maxLines: 3,
